...
the model object and initialize all the components with specific models, which we do
below. Note that because we explicitly calculated the rough equilibrium values
...
_before_ any other updating functions are called. This is crucical for properly updating
models in **Micro-MoB**.
