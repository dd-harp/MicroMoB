...
Thank you for taking the time to contribute to **ramp.dts** (Discrete Time Simulation for Mosquito-Borne pathogens).
...
We periodically merge `dev` into `main` for small release updates. These releases will appear on the [GitHub releases page](https://github.com/dd-harp/ramp.dts/releases). 
...
runs during pull requests to `[main, dev]` and uses our [codecov.io integration](https://app.codecov.io/gh/dd-harp/ramp.dts)
