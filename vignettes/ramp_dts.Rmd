...
methods which are required to be implemented can be found [here](https://dd-harp.github.io/ramp.dts/reference/index.html#adult-mosquito-component).
...
and the interface methods with are required to be implemented can be found [here](https://dd-harp.github.io/ramp.dts/reference/index.html#aquatic-immature-mosquito-component).

### Humans

The human component updates human populations. The interface is defined in `R/humans_interface.R`,
and the interface methods with are required to be implemented can be found [here](https://dd-harp.github.io/ramp.dts/reference/index.html#human-component).

### Visitor

The human component updates human populations outside of the resident population of the geographic area being simulated. 
The interface is defined in `R/visitor_interface.R`, and the interface methods with are required to be implemented can be found [here](https://dd-harp.github.io/ramp.dts/reference/index.html#visitor-component).
...
and the interface methods with are required to be implemented can be found [here](https://dd-harp.github.io/ramp.dts/reference/index.html#alternative-blood-hosts-component).
