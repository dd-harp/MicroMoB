...
The aquatic (immature) mosquito compoment $L$ is in blue. Over a time step, it takes in eggs laid by
ovipositing adult mosquitoes $G$, and updates state, producing newly emerging adults $\Lambda$.
These emergents are added to the adult mosquito component (green). In the adult component,
