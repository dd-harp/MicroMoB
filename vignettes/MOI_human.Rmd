...
In **ramp.dts** the `MOI` vector is allowed to grow as needed to accommodate arbitrarily
...
First we set up and run a simulation for 1000 days. We use `make_ramp.dts()`
...
mod <- make_ramp_dts(tmax = tmax, p = 1)
