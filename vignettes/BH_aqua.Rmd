...
`setup_mosquito_RM()` will set up a Ross-Macdonal model of adult mosquito dynamics.
...
Now we process the output and plot the results. Determinstic solutions are solid lines
